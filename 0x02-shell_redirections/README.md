...
File 11-directories is a script that counts the number of directories and sub-directory in the current directory.
...
File 15-countthatword displays the number of lines that contain the pattern “bin" in the file/ect/passwd
File 16-whatsnext displays lines containing the pattern “root” and 3 lines after them in the file/ect/passwd
...
File 22-users_and_homes is a script that displays all users and their home directory, sort by user.
